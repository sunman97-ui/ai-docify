...
from src.ai_docify.config import (
    load_config,
    validate_model,
    get_model_price,
    DEFAULT_CONFIG,
...
@patch("src.ai_docify.config.CONFIG_PATH")
def test_load_config_success(mock_path):
    ...
    with patch("builtins.open", mock_open(read_data=mock_file_content)) as mock_file:
        ...
        # Verify we open the file (path object handling varies by python version mock,
        # checking call count is usually sufficient safe guard)
...
@patch("src.ai_docify.config.load_config")
